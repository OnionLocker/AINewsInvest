      ...
      {showAdd && (
        <Card>
          <form onSubmit={handleAdd} className="flex flex-wrap items-end gap-3">
            <div>
              <label className="mb-1 block text-xs text-slate-400">浠ｇ爜</label>
              <input
                value={addTicker}
            ...
            <div>
              <label className="mb-1 block text-xs text-slate-400">鍚嶇О</label>
              <input
                value={addName}
          ...
          <table className="w-full text-left text-sm">
            <thead>
              <tr className="border-b border-slate-800/40 text-xs text-slate-500">
                ...
                <th className="px-3 py-2 text-right">鎴愪氦閲�</th>
