...
const navItems = [
  { to: "/dashboard", icon: LayoutDashboard, label: "浠〃鐩�" },
  { to: "/recommendations/us", icon: DollarSign, label: "缇庤偂鎺ㄨ崘" },
  { to: "/recommendations/hk", icon: TrendingUp, label: "娓偂鎺ㄨ崘" },
  { to: "/win-rate", icon: Trophy, label: "鑳滅巼缁熻" },
  { to: "/screening", icon: Search, label: "閫夎偂绛涢€�" },
  { to: "/analysis", icon: BarChart3, label: "娣卞害鍒嗘瀽" },
  { to: "/watchlist", icon: Heart, label: "鑷€夎偂" },
];
      ...
      <div className="border-t border-slate-800/60 px-3 py-3">
        <div className="mb-2 flex items-center gap-2 px-1">
          ...
          <div>
            ...
            {user?.is_admin && (
              <span className="text-[10px] text-indigo-400">绠＄悊鍛�</span>
            )}
          </div>
        </div>
        <button
